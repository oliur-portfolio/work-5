!(function () {
    var e,
        ...
        o,
        n,
        r = { frameRate: 10, animationTime: 500, stepSize: 50, pulseAlgorithm: !0, pulseScale: 4, pulseNormalize: 1, accelerationDelta: 50, accelerationMax: 3, keyboardSupport: !0, arrowScroll: 50, fixedBackground: !0, excluded: "" },
        a = r,
        l = !1,
        i = !1,
        c = { x: 0, y: 0 },
    ...
    function w() {
        if (!s && document.body) {
            ...
            var n = document.body,
                ...
                d = n.scrollHeight;
            if (((u = document.compatMode.indexOf("CSS") >= 0 ? r : n), (e = n), a.keyboardSupport && A("keydown", S), top != self)) i = !0;
                ...
                (m.style.cssText = "position:absolute; z-index:-10000; top:0; left:0; right:0; height:" + u.scrollHeight + "px"),
                    ...
                    setTimeout(o, 10),
                    A("resize", o);
                if (((t = new q(o)).observe(n, { attributes: !0, childList: !0, characterData: !1 }), u.offsetHeight <= c)) {
            ...
            var d = function (n) {
                for (var r = Date.now(), l = 0, i = 0, c = 0; c < p.length; c++) {
                    ...
                    var w = (s.x * h - s.lastX) >> 0,
                        y = (s.y * h - s.lastY) >> 0;
                    (l += w), (i += y), (s.lastX += w), (s.lastY += y), m && (p.splice(c, 1), c--);
                }
                u ? window.scrollBy(l, i) : (l && (e.scrollLeft += l), i && (e.scrollTop += i)), t || o || (p = []), p.length ? R(d, e, 1e3 / a.frameRate + 1) : ((v = !1), null != e.$scrollBehavior && ((e.style.scrollBehavior = e.$scrollBehavior), (e.$scrollBehavior = null)));
            };
            R(d, e, 0), (v = !0);
        }
    }
